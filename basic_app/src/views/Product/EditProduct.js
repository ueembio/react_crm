...
import { updateList } from '../../services/products';
                ...
                <div class="col-md-12">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" id="exampleInputName" type="hidden" value={itemId} />
